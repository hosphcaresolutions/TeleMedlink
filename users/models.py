...
class Users(AbstractUser):
    ...
    profile_avatar = models.ImageField(upload_to="users/profiles", blank=True, null=True, default="assets/img/def.jpeg")
...
def profile_picture(self):
    """Returns default profile image if none is uploaded."""
    if self.profile_avatar:
        return self.profile_avatar.url
    return "assets/img/def.jpeg"
...
class Report(models.Model):
    ...
    def __str__(self):
        return f"Report {self.id_report} - {self.patient.user.username}"